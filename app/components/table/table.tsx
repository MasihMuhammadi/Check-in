            ...
            {bodyRows?.map((row: any, rowIndex: number) => {
              ...
              return (
                <React.Fragment key={rowIndex}>
                  {isClass ? (
                    <tr
                      className="odd:bg-gray-100 even:bg-gray-50 h-10 rounded-xl px-4 py-3 cursor-pointer"
                      key={rowIndex}
                    >
                      ...
                      <td>
                        <Link
                          href={`${
                            teacherData?.data?.data?.teacher?.handle
                          }/classes/${row[0].split(" ").join("-")}`}
                        >
                          <GoToIcon />
                        </Link>
                      </td>
                    ...
                    <tr
                      key={rowIndex}
                      className="odd:bg-gray-100 even:bg-gray-50 h-10 rounded-xl px-4 py-3"
                    >
