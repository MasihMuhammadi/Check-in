...
const LandingPageText = () => {
  ...
  return (
    <div className="leading mt-28 ">
      <div className="text-5xl leading-[60px] inline ">
        ...
        <div className="  inline-flex pt-3 top-4 lef-2  flex-col justify-end items-center w-40 h-12  overflow-hidden relative">
          <span
            className={`  text-4xl duration-[3000ms] transition-all font-semibold left-0  ${
              isVisible
          ...
          <span
            className={` text-4xl duration-[3000ms] transition-all delay-[1100ms]  font-semibold left-0 ${
              isVisible
